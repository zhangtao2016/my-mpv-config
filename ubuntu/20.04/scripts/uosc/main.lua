...
defaults = {
	...
	-- controls ='menu,ST-stats_tog,gap,play_pause,gap,subtitles,audio,<has_chapter>chapters,<has_many_edition>editions,<has_many_video>video,<stream>stream-quality,gap,space,,space,shuffle,loop-playlist,loop-file,gap,prev,items,next,gap,fullscreen'        
    controls = 'ontop,gap,items,gap,shuffle,loop-playlist,loop-file,space,prev,gap,pause_play,gap,next,space,video,subtitles,audio,gap,ST-stats_tog,gap,fullscreen',
	controls_size = 45,
	controls_margin = 8,
	controls_spacing = 2,
